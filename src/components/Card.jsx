...
const Card = ({ data }) => {
  return (
    <div className=" carousel carousel-end rounded-box w-full max-w-7xl mt-6">
      {data?.days?.length > 0 ? (
        <div className="carousel carousel-end rounded-box  ">
          <div className="carousel-item ">
            {data.days.map((day) => (
              <div
                key={day.datetime}
                className="gap-x-12  bg-amber-50 mr-6 rounded-2xl flex flex-col items-center justify-center text-black p-4 max-w-xl"
              >
